...
CascadeClassifier weed_Cascade, Object_Cascade;
...
void weed_detection()
{
    if(!weed_Cascade.load("//home//pi//Desktop//MACHINE LEARNING//Stop_cascade.xml"))
    {
    ...
    weed_Cascade.detectMultiScale(gray_Stop, Stop);
	...
	putText(RoI_Stop, "weed", P1, FONT_HERSHEY_PLAIN, 1,  Scalar(0, 0, 255, 255), 2);
